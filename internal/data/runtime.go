...
func (r *Runtime) UnmarshalJSON(jsonValue []byte) error {
	...
	// Otherwise, parse the string containing the number into an int32. If this fails
	...
	// use the * operator to dereference the receiver in order to set the underlying value
	// of the pointer.
	*r = Runtime(i)
